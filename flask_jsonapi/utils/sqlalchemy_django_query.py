...
from sqlalchemy.sql.expression import _interpret_as_from
...
class Query(object):
    ...
    def _set_entities(self, entities, entity_wrapper=None):
        if entity_wrapper is None:
            entity_wrapper = query._QueryEntity
        self._entities = []
    ...
    def _mapper_entities(self):
        for ent in self._entities:
            if isinstance(ent, query._MapperEntity):
                yield ent
    ...
    def add_entity(self, entity, alias=None):
        ...
        m = query._MapperEntity(self, entity)
    ...
    def _join_place_explicit_left_side(self, left):
        ...
        if (
            ...
            for idx, ent in enumerate(self._entities):
                ...
                # matching?
                if isinstance(ent, query._MapperEntity) and ent.corresponds_to(left):
    ...
    def _compile_context(self, labels=True):
        context = query.QueryContext(self)
