...
Let say we need to make API for simple blog page which have posts, comments and it's authors.
...
Database for blog page consists of 3 tables: user, post and comment.
