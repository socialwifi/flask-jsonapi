...
class RepositoryWithBeginTransaction(flask_jsonapi.resource_repositories.resource_repository.ResourceRepository):
...
class RepositoryWithOutBeginTransaction(flask_jsonapi.resource_repositories.resource_repository.ResourceRepository):
    children_repositories = {}
    very_important_test_value = 0
